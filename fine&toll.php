...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <div id="sec2" style="color: #777;background-color:white;text-align:center;padding:50px 80px;text-align: justify;">
        <h3 style="text-align:center;">Car DATA ENTRY</h3>
<br>
        <section class="menu-content">
            ...
            if(mysqli_num_rows($result1) > 0) {
                while($row1 = mysqli_fetch_assoc($result1)){
                    ...
                    $model_year = $row1["model_year"];
                    $number_plate = $row1["car_nameplate"];
                    ?>
            <a href="employeeview.php?id=<?php echo($car_id) ?>">
            <div class="sub-menu">
            

            <img class="card-img-top" src="<?php echo $car_img; ?>" alt="Card image cap">
            <h5><b> <?php echo $car_name; ?> </b></h5>
            <h6> Number Plate: <?php echo ($number_plate) ?></h6>
            <h6> Model Year: <?php echo ($model_year) ?></h6>
            <h6> Color: <?php echo ($car_color) ?></h6>            
