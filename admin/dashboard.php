...
$cust=$query->rowCount();
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($cust);?></div>
													<div class="stat-panel-title text-uppercase">Manage Customers</div>
												</div>
											</div>
											<a href="manage-customers.php" class="block-anchor panel-footer">Full Detail <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
...
$employees=$query3->rowCount();
?>												
													<div class="stat-panel-number h1 "><?php echo htmlentities($employees);?></div>
													<div class="stat-panel-title text-uppercase">Manage Employees</div>
												</div>
											</div>
											<a href="manage-employees.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
