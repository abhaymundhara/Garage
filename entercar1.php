...
$insurance_expiry = date('d-m-Y', strtotime($_POST['insurance_expiry']));
$last_service = date('d-m-Y', strtotime($_POST['last_service']));
$next_service = date('d-m-Y', strtotime($_POST['next_service']));
...
if (!empty($_FILES["uploadedimage"]["name"])) {
    ...
    if(move_uploaded_file($temp_name, $target_path)) {
      ...
      //  $query0 = "UPDATE cars SET car_img = '$target_path' WHERE ";
        ...
        $query = "INSERT into cars(car_name,car_nameplate,car_regno,car_regname,model_year,car_color,rc_expiry,insurance_expiry,last_service,next_service,car_img,car_availability) VALUES('" . $car_name . "','" . $car_nameplate . "','" . $car_regno . "','" . $car_regname . "','" . $model_year . "','" . $car_color . "','" . $rc_expiry . "','" . $insurance_expiry . "','" . $last_service . "','" . $next_service . "','". $target_path ."','" . $car_availability ."')";
...
// $query2 = "INSERT into employeecars(car_id,employee_username) values('" . $car_id ."','" . $_SESSION['login_employee'] . "')";
